...
class Scribe:
    ...
    def _transcribe_audio(self, path):
        if not WHISPER_AVAILABLE:
            return "[Scribe] Audio transcription requires 'whisper' package. Install with: pip install openai-whisper"
    ...
    def _ocr_image(self, path):
        if not TESSERACT_AVAILABLE:
            return "[Scribe] OCR requires 'pytesseract' and 'Pillow' packages."
